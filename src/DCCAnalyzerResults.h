...
enum eFrameType { FRAME_ERR, FRAME_PREAMBLE, FRAME_CUTOUT, FRAME_SBIT, FRAME_ADDR, FRAME_EADDR, FRAME_CMD, FRAME_ACC, FRAME_SVC, FRAME_DATA, FRAME_CHECKSUM, FRAME_PEBIT };
